...
export const MovieDetailsHeader = ({ data }) => {
	const backdropUrl = data.backdrop_path
		? `${TMDB_IMAGE_CONFIG.base_url}${TMDB_IMAGE_CONFIG.backdrop_sizes.original}${data.backdrop_path}`
		: null;

	return (
		<div className="h-svh">
			<div
				className="h-svh bg-cover bg-center bg-no-repeat bg-fixed max-h-svh"
				style={{
